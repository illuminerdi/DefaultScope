<cfcomponent output="false">
  ...
  <cffunction name="$IsValidFindAllArgument">
  	...
  	<cfscript>
  		return iif( ListFindNoCase("where,order,select,distinct,include,maxRows,page,perPage,count,handle,cache,reload,parameterize,returnAs,returnIncluded",arguments.scopeName), true, false);
  	</cfscript>
  </cffunction>
